    ...
    render() {
        ...
        const chatMessages = chat.map(message => {
            if (message.user_id == user.id) {
                return (
                    <div key={message.id} id="my-message" className="chatMessage-container">
                        <div className="chat-message">
                            <p className="words">{message.message}</p>
                            <p id="message-details"> {moment(message['created_at']).fromNow()}</p>
                        </div>
                    </div>
                );
            } else {
                return (
                    <div key={message.id} className="chatMessage-container">
                        <div className="chat-message">
                            <p id="chat-name" className="capitalize">{message.first}</p>
                            <p className="words">{message.message}</p>
                            <p id="message-details"> {moment(message['created_at']).fromNow()}</p>
                        </div>
                    </div>
            ...
            <div className="main">
                <div className="chat-main">
                    ...
                    <div className="chat-side">
                        ...
                        <div className="profiles-end"></div>
                    </div>
                </div>
            </div>
        );
